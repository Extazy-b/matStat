...
\begin{enumerate}[label=\textbf{\arabic*.}, left=0pt]
    ...
    \item Случайные величины \(U_1, \dots, U_n\) независимы и имеют равномерное распределение
          ...
          \begin{solution}
              \begin{enumerate}
                  \item \(f_{U_i}(x) = \ind_{[0, 1]}\)
                  \item \(f_U(X) = f_{U_1, \dots, U_n}(x_1, \dots, x_n) = \prod_1^n f_{U_i}(x) = \ind_{[0, 1]^n}\)
          ...
          \begin{solution}
              \begin{enumerate}
                \item \(Z = \left(\begin{matrix}
                            Z_1 \\ \vdots \\ Z_{n+1}
                        \end{matrix}\right)\)
                \item \(f_Z(X) = \ind_{{(0, +\infty]}^{n+1}}\cdot\lambda^{n+1} e^{-\lambda \sum_{1}^{n+1}x_i}\)                \item \(S_{n+1} = \sum_{1}^{n+1} Z_i\)
                \item \(f_{S_{n+1}}(s) = \ind_{{(0, +\infty]}}\cdot\frac{s^{n} \cdot e^{-s}}{n!}\)
                \item \(\)
              \end{enumerate}
          \end{solution}
\end{enumerate}
